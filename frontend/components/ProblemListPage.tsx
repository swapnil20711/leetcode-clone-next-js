          ...
          <div className="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
             ...
             <div className="relative w-full md:w-96">
               ...
               <input
                  ...
                  className="w-full pl-10 pr-4 py-2 bg-dark-layer border border-white/10 rounded-lg focus:ring-2 focus:ring-brand-orange focus:border-transparent text-white placeholder-gray-500 outline-none"
                  value={filter}
              ...
              {filteredProblems.map((problem) => (
                <div key={problem.id} className="grid grid-cols-12 gap-4 p-4 items-center hover:bg-white/5 transition-colors group">
                  <div className="col-span-1 text-green-500">
                    {/* Mock status for now */}
                    <CheckCircle2 size={18} className="text-gray-700 group-hover:text-green-500/50" />
                  </div>
